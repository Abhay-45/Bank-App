...
function Page() {
  ...
  function getCreditPercentage() {
    const creditPercentage = (customerData?.creditSpent / customerData?.creditLimit) * 100;
    return (creditPercentage?.toFixed(2));
  }
          ...
          <Grid container spacing={3}>
            <Grid xs={12} sm={6} lg={3}>
              <OverviewBudget
                ...
                positive
                sx={{ height: "100%" }}
                value={`£${customerData?.currentAccount}`}
              />
            </Grid>
            <Grid xs={12} sm={6} lg={3}>
